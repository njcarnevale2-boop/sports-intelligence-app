...
def get_odds_status() -> Dict[str, Any]:
    ...
    try:
        ...
        refresh_run = {
            ...
            "quotaGuardAllowed": bool(latest_refresh_telemetry[7]) if latest_refresh_telemetry and latest_refresh_telemetry[7] is not None else None,
            "quotaGuardReason": latest_refresh_telemetry[8] if latest_refresh_telemetry else None,
            "providerEventsReturned": int(latest_refresh_telemetry[9]) if latest_refresh_telemetry and latest_refresh_telemetry[9] is not None else None,
            "eventsRejectedByWindow": int(latest_refresh_telemetry[10]) if latest_refresh_telemetry and latest_refresh_telemetry[10] is not None else None,
            "eventsRejectedByScheduleMatch": int(latest_refresh_telemetry[11]) if latest_refresh_telemetry and latest_refresh_telemetry[11] is not None else None,
            "eventsRejectedByTeamMatch": int(latest_refresh_telemetry[12]) if latest_refresh_telemetry and latest_refresh_telemetry[12] is not None else None,
            "eventsRejectedByDateMatch": int(latest_refresh_telemetry[13]) if latest_refresh_telemetry and latest_refresh_telemetry[13] is not None else None,
            "eventsAccepted": int(latest_refresh_telemetry[14]) if latest_refresh_telemetry and latest_refresh_telemetry[14] is not None else None,
            "snapshotRowsInserted": int(latest_refresh_telemetry[15]) if latest_refresh_telemetry and latest_refresh_telemetry[15] is not None else None,
        }
        return {
            "oddsProvider": "The Odds API",
